...
*/
		...
		$params = array(
			...
			'mpscancelurl'	  => "https://beta.alterspace.gg/purchase-item-payment-fail.php?sid=".$_POST['session_usr_id']."&id1=".$str_rand."&id2=".$your_orderid."&id3=".$_POST['cust_id_parameter']."&id4=".$_POST['type_1']."&id5=".$_POST['total_in_cart_value']."&id6=".$_POST['promo_code']."&id7=".$_POST['discount']."&id8=".$_POST['total_amount']."&id9=".$_POST['admin_fee']."", 
			//'mpsreturnurl'    => "https://beta.alterspace.gg/razer_return.php",
			'mpsreturnurl'    => "https://beta.alterspace.gg/purchase-item-payment-success.php?sid=".$_POST['session_usr_id']."&id1=".$str_rand."&id2=".$your_orderid."&id3=".$_POST['cust_id_parameter']."&id4=".$_POST['type_1']."&id5=".$_POST['total_in_cart_value']."&id6=".$_POST['promo_code']."&id7=".$_POST['discount']."&id8=".$_POST['total_amount']."&id9=".$_POST['admin_fee']."",  
