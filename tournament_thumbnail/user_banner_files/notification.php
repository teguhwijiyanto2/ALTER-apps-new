...
$results = DB::query("SELECT notifications.*, users.*, notifications.id AS notif_id FROM notifications JOIN users ON notifications.notif_from = users.id WHERE notif_for = %i ORDER BY created_date DESC", 19);
          ...
          <div class="">
            ...
            <div aria-label="List New" class="">
              ...
              <?php if($result['category'] == 'post-like'){?>
                  <a href="profile.php?user_id_profile=<?= $result['notif_from']; ?>">
                    <div
                    ...
                    >
                      <img
						...
						onclick="window.location.href='profile.php?user_id_profile=<?= $result['notif_from']; ?>';"
                      />
              ...
              ?>
                  <a href="#">
                    ...
                    >
                      ...
                      <div class="flex__1 fs-7"
						style="cursor: pointer;"
						onclick="window.location.href='myorder-play-review.php?id=<?php echo $result['data'] ?>&view=1';"					  
					  >
                ...
                ?>
                  <a href="#">
                    ...
                    >
                      ...
                      <div class="flex__1 fs-7"
						style="cursor: pointer;"
						onclick="window.location.href='tournament-detail.php?tid=<?= $tour['id']?>';"						  
					  >
                        <b><?= ucfirst($first_name) ?></b>
