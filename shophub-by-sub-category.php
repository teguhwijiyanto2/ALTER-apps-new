...
<?php
$results_A2 = DB::query("SELECT * FROM billing_items_excel WHERE category=%i AND sub_category=%s ORDER BY id ASC", $_GET['cat'], $sub_category);			
