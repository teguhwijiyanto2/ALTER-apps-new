							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">ADMIN FEE </h4>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
...
$no = 0;
$results_2 = DB::query("
	select * from admin_fee	
");
foreach ($results_2 as $row_2) {
	$no++;
	echo "
												<tr>
													<td>IDR ".number_format($row_2['value'])."</td>																										
													<td>
														<div class='form-button-action'>
															<a href='admin-fee-update.php?idx=".$row_2['id']."' type='button' data-toggle='tooltip' title='Change value' class='btn btn-link btn-primary btn-lg' data-original-title='Change value'>
