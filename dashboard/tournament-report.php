							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Tournament Report </h4>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
...
foreach ($results_2 as $row_2) {
	$tour_profile = DB::queryFirstRow("SELECT * FROM users where id=%i", $row_2['creator_user_id']);
	$tour_result = DB::queryFirstRow("SELECT * FROM tournament_result JOIN tournament_teams ON tournament_teams.id = tournament_result.result_1 where tournament_id=%i", $row_2['id']);
	$tour = $tour_profile ? $tour_profile['name'] : '-';
	$winner = $tour_result ? $tour_result['team_name'] : '-';
	...
	echo "
												<tr>
												    <td>".$no."</td>
													<td>".$row_2['name']."</td>
													<td>".$row_2['game_name_id']."</td>
													<td>".$tour."</td>
													<td>".$row_2['date_from']."</td>
													<td>".$row_2['participant_number']."</td>
													<td>".$row_2['reward_1st'] + $row_2['reward_2nd'] + $row_2['reward_3rd']."</td>
													<td>".$winner."</td>
													<td>".$row_2['status']."</td>
												</tr>
	";
