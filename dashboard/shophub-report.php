							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Shophub Report </h4>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
...
foreach ($results_2 as $row_2) {
	$users = DB::queryFirstRow("SELECT * FROM users where id=%i", $row_2['user_id']);
	...
	echo "
												<tr>
													...
													<td>".$name."</td>
													<td>".$row_2['name']."</td>
													<td>".$row_2['purchase_time']."</td>
													<td>1</td>
													<td>".$row_2['total_amount']."</td>
													<td>".$row_2['payment_method']."</td>
													<td>".$row_2['payment_status']."</td>
												</tr>
	";
} // foreach ($results_2 as $row_2) {											
?>												
