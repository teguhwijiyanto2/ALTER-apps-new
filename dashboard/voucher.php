							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center justify-content-between">
										...
										<a class="btn btn-success" href="voucher-add.php">Tambah</a>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
...
foreach ($results_2 as $row_2) {
	...
	if($row_2['category'] == 1) $categ = 'Mobile Prepaid'; 
	if($row_2['category'] == 2) $categ = 'Mobile Data'; 
	if($row_2['category'] == 3) $categ = 'Top Up Game'; 
	if($row_2['category'] == 4) $categ = 'E Wallet'; 
	if($row_2['category'] == 5) $categ = 'Voucher'; 
	echo "
												<tr>
												    <td>".$no."</td>
													<td>".$row_2['name']."</td>
													...
													<td>".$row_2['date_to']."</td>
													<td>".$row_2['minimun_purchase']."</td>
													<td>".$row_2['code']."</td>
													<td>
														<div class='form-button-action'>
															<a href='voucher-edit.php?idx=".$row_2['id']."' type='button' data-toggle='tooltip' title='Edit' class='btn btn-link btn-primary btn-lg' data-original-title='Proceed withdraw'>
