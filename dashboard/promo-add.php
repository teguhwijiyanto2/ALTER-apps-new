						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Promo :: Add</div>
								</div>
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group form-group-default">
												...
												<input type="text" name="promo_code" class="form-control" required value="">
											</div>
											<div class="form-group form-group-default">
											...
											<div class="form-group form-group-default">
												...
												<input type="number" name="quota" class="form-control" required value="0">
											</div>
