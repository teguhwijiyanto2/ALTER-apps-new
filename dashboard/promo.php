							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center justify-content-between">
										...
										<a class="btn btn-success" href="promo-add.php">Tambah</a>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
												...
												<tr>
													...
													<td>
														<div class='form-button-action'>
															<a href='promo-edit.php?idx=".$row_2['id']."' type='button' data-toggle='tooltip' title='Edit' class='btn btn-link btn-primary btn-lg' data-original-title='Proceed withdraw'>
