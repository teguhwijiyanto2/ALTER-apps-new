...
$results_1 = DB::queryFirstRow("select * from billing_items_excel where id=%i", $_GET['idx']);
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">BILLER ITEMS :: Confirm Update</div>
								</div>
								<div class="card-body">
								<form action="biller-items-update-process.php" method="post">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											<div class="form-group">
												<label for="disableinput">DATA</label>
											</div>										
											<div class="form-group form-group-default">
												<label for="disableinput">Payee Code</label>
												<input type="text" class="form-control" disabled value="<?php echo $results_1['payee_code']; ?>">
											</div>

											<div class="form-group form-group-default">
												<label for="disableinput">Product Code</label>
												<input type="text" class="form-control" disabled value="<?php echo $results_1['product_code']; ?>">
											</div>
											
											<div class="form-group form-group-default">
												<label for="disableinput">Product Name</label>
												<input type="text" class="form-control" disabled value="<?php echo $results_1['product_name']; ?>">
											</div>
											
											<div class="form-group form-group-default">
												<label for="disableinput">Product Description</label>
												<input type="text" class="form-control" disabled value="<?php echo $results_1['product_description']; ?>">
											</div>										
										</div>
										
										<div class="col-md-6 col-lg-6">
											<div class="form-group">
												<label for="disableinput">PRICE</label>
											</div>										

											<div class="form-group">
												<label for="disableinput">E2Pay Price :</label>
												<input type="text" class="form-control" disabled value="<?php echo number_format($results_1['e2pay_price']); ?>">
											</div>
											
											<div class="form-group">
												<label for="disableinput">Current CLIENT Price:</label>
												<input type="text" class="form-control" disabled value="<?php echo number_format($results_1['client_price']); ?>">
											</div>
											
											<div class="form-group">
												<label for="disableinput">NEW CLIENT Price:</label>
												<input type="number" required name="new_client_price" class="form-control" placeholder="<?php echo $results_1['client_price']; ?>">
											</div>	

											<div class="form-group">
												<input class="btn btn-success" type="Submit" value="Submit">
												<a class="btn btn-danger" href="biller-items.php">Cancel</a>
											</div>
