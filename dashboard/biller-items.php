							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">BILLER ITEMS </h4>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
...
$no = 0;
$results_2 = DB::query("
	select * from billing_items_excel
	where id>1	
	order by id asc	
");
// id=1 --> sementara dipakai utk Commission Fee-nya Alter
foreach ($results_2 as $row_2) {
	$no++;
	echo "
												<tr>
												    <td>".$no."</td>
													<td>".$row_2['payee_code']."</td>
													<td>".$row_2['product_code']."</td>
													<td>".$row_2['product_name']."</td>
													<td>".$row_2['product_description']."</td>													
													<td>IDR ".number_format($row_2['e2pay_price'])."</td>											
													<td>IDR ".number_format($row_2['client_price'])."</td>													
													<td>
														<div class='form-button-action'>
															<a href='biller-items-update.php?idx=".$row_2['id']."' type='button' data-toggle='tooltip' title='Change value' class='btn btn-link btn-primary btn-lg' data-original-title='Change value'>
