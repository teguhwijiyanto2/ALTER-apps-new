...
$results_1 = DB::queryFirstRow("select * from voucher where id=%i", $_GET['idx']);
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Voucher :: Edit</div>
								</div>
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											<div class="form-group">
												<label for="disableinput">REQUEST DATA</label>
											</div>										
											<div class="form-group form-group-default">
												<label for="disableinput">Name</label>
												<input type="text" name="name" required class="form-control" value="<?php echo $results_1['name']; ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Description</label>
												<input type="text" name="description" required class="form-control" value="<?php echo $results_1['description']; ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Date From</label>
												<input type="date" name="date_from" required class="form-control" value="<?php echo date_format(date_create($results_1['date_from']), "Y-m-d"); ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Date To</label>
												<input type="date" name="date_to" required class="form-control" value="<?php echo date_format(date_create($results_1['date_to']), "Y-m-d"); ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Value</label>
												<input type="text" name="value" required class="form-control" value="<?php echo $results_1['value']; ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Min Purchase</label>
												<input type="number" name="minimun_purchase" required class="form-control" value="<?php echo $results_1['minimun_purchase']; ?>">
											</div>
										...
										<div class="form-group">
												...
												<select required class="form-control" name="category">
													...
													<option value="3">Top Up Game</option>
											...
											<div class="form-group">
												...
												<a class="btn btn-danger" href="voucher.php">Cancel</a>
											</div>
