...
$results_1 = DB::queryFirstRow("select * from commission_fee where id=%i", $_GET['idx']);
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">COMMISSION FEE :: Update</div>
								</div>
								<div class="card-body">
								<form action="commission-fee-update-process.php" method="post">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">									
											...
											<div class="form-group">
												<label for="disableinput">NEW Commission Fee (%) :</label>
												<input type="text" name="value" class="form-control" value="<?php echo $results_1['value']; ?>">
											</div>	

											<div class="form-group">
												<input class="btn btn-success" type="Submit" value="Submit">
												<a class="btn btn-danger" href="commission-fee.php">Cancel</a>
											</div>
