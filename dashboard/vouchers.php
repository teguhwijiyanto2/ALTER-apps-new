							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center justify-content-between">
										...
										<a class="btn btn-success" href="vouchers-add.php">Tambah</a>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
										...
										<table id="add-row" class="display table table-striped table-hover" >
											<thead>
												<tr>
													...
													<th>Description</th>
													<th>Voucher's Prefix</th>
													<th>Num. of Vouchers</th>
													<th>Category</th>
													<th>Vouchers Type</th>
													<th>Value</th>
													<th>Applied From</th>
...
foreach ($results_2 as $row_2) {
	...
	echo "
												<tr>
												    <td>".$no."</td>
													<td>".$row_2['name']."</td>
													<td>".$row_2['description']."</td>													
													<td>".$row_2['prefix']."</td>
													<td>".$row_2['num_of_vouchers']."</td>													
													<td>".$array_item_category[$row_2['item_category']]."</td>													
													<td>".$row_2['discount_cashback_type']."</td>
													<td>".$row_2['voucher_value']."</td>
													<td>".$row_2['date_from']."</td>
													<td>".$row_2['date_to']."</td>
													<td>".$row_2['min_purchase']."</td>
													<td>".$row_2['num_used']."</td>
													<td>".$row_2['num_available']."</td>
													
													<!--<td>".$row_2['status']."</td>-->
													<td>
														<div class='form-button-action'>
															<a href='vouchers-codes.php?uuidx=".$row_2['uuid']."' type='button' data-toggle='tooltip' title='View Voucher Codes' class='btn btn-link btn-primary btn-lg' data-original-title='Proceed withdraw'>
																<i class='fa fa-list'></i>
															</a>
															<!--
															<a href='vouchers-edit.php?uuidx=".$row_2['uuid']."' type='button' data-toggle='tooltip' title='Edit' class='btn btn-link btn-primary btn-lg' data-original-title='Proceed withdraw'>
