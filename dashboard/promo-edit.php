...
$results_1 = DB::queryFirstRow("select * from promo where id=%i", $_GET['idx']);
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Promo :: Edit</div>
								</div>
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group form-group-default">
												<label for="disableinput">Promo Name</label>
												<input type="text" name="name" class="form-control" required value="<?php echo $results_1['name']; ?>">
											</div>											
											<div class="form-group form-group-default">
												<label for="disableinput">Promo Code</label>
												<input type="text" name="promo_code" class="form-control" required value="<?php echo $results_1['promo_code']; ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Description</label>
												<input type="text" name="description" class="form-control" required value="<?php echo $results_1['description']; ?>">
											</div>
											<div class="form-group form-group-default">
											...
											<div class="form-group form-group-default">
												...
												<input type="date" name="date_to" class="form-control" required value="<?php echo $results_1['date_to']; ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Minimum Purchase</label>
												<input type="number" name="min_purchase" class="form-control" required value="<?php echo $results_1['min_purchase']; ?>">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Quota</label>
												<input type="number" name="quota" class="form-control" required value="<?php echo $results_1['quota']; ?>">
											</div>
											...
											<div class="form-group">
												...
												<a class="btn btn-danger" href="promo.php">Cancel</a>
											</div>
