						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Vouchers :: Add</div>
								</div>
								<div class="card-body">
...
<script>
	function checkDiscMax100(discount_cashback_type) {
		if(discount_cashback_type=="%") {
			...
			if((document.getElementById('voucher_value').value * 1) > 100) {
				alert("Maximum value for % is 100 !");
				document.getElementById('voucher_value').value = "100";
				document.getElementById('voucher_value').select();
			}			
		} // if(discount_cashback_type=="%") {
		else {
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group form-group-default">
												...
												<input type="number" name="voucher_value" id="voucher_value" class="form-control" required value="0" onkeyup="checkDiscMax100(document.getElementById('discount_cashback_type').value);">
											...
											<div class="form-group form-group-default">
												...
												<input type="date" name="date_to" class="form-control" required value="">
											</div>
											<div class="form-group form-group-default">
												<label for="disableinput">Minimum Purchase</label>
												<input type="number" name="min_purchase" class="form-control" required value="0">
											</div>
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group form-group-default">
												...
												<input type="number" name="num_of_vouchers" class="form-control" required value="0">
											</div>

											<div class="form-group form-group-default">
												<label for="disableinput">Length of Unique Code</label>
												<input type="number" name="length_of_codes" class="form-control" required value="5">
											</div>
