...
*/
  ...
  */
  ...
  public static $dbName = 'aws_alter_apps_merged_db_local';
...
<?php
if(isset($_SESSION["session_usr_id"]) && $_SESSION["session_usr_id"] !== "") {
		
	function url_origin2( $s, $use_forwarded_host = false )
	{
	...
	function full_url2( $s, $use_forwarded_host = false )
	{
		return url_origin2( $s, $use_forwarded_host ) . $s['REQUEST_URI'];
	}

	$absolute_url = full_url2( $_SERVER );
	//echo $absolute_url;
	
	if($absolute_url=="https://beta.alterspace.gg/" || $absolute_url=="https://beta.alterspace.gg/auth.php" || $absolute_url=="https://beta.alterspace.gg/login.php" || $absolute_url=="https://beta.alterspace.gg/login.php?s=email" || $absolute_url=="https://beta.alterspace.gg/login.php?s=phone") {	
		echo("
