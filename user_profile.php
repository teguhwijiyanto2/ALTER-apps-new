              ...
              <?php if($option){ ?>
                ...
                >
                  <div
                    ...
                    <span><small><?= ($option) ? $option['fee']." / ".$option['time']." session" : '' ?></small></span>
                </div>
                <div
                  class="d-flex flex-row align-items-center gap-2 bg-dark px-2 mt-2 rounded-pill"
                  style="width: fit-content"
        ...
        <div class="p-3 bg-dark rounded-3 mt-3">
          ...
          <div>
            ...
            <div class="row row-cols-auto g-2">
              <div class="col">
                <a
                  href="https://www.instagram.com/sharer.php?u=https://beta.alterspace.gg/profile.php?user_id_profile=<?php echo $_SESSION["session_usr_id"]; ?>"
                  class="social__media-icon rounded-circle bg-secondary"
                >
                  <i class="bi bi-instagram fs-5"></i>
                </a>
              ...
              <div class="col">
                <a
                  href="https://twitter.com/intent/tweet?text=<?php echo urlencode($_SESSION["session_usr_name"]); ?>&url=https://beta.alterspace.gg/profile.php?user_id_profile=<?php echo $_SESSION["session_usr_id"]; ?>"
                  class="social__media-icon rounded-circle bg-secondary"
                >
                  <i class="bi bi-twitter-x fs-5"></i>
                </a>
             ...
             <div class="col">
                <a target='_blank'
                  href="https://www.facebook.com/sharer.php?u=https://beta.alterspace.gg/profile.php?user_id_profile=<?php echo $_SESSION["session_usr_id"]; ?>;"
                  class="social__media-icon rounded-circle bg-secondary"
                >
                  <i class="bi bi-facebook fs-5"></i>
                </a>
              ...
              <div class="col">
                <a target='_blank'
                  href="https://api.whatsapp.com/send?text=https://beta.alterspace.gg/profile.php?user_id_profile=<?php echo $_SESSION["session_usr_id"]; ?>"
                  class="social__media-icon rounded-circle bg-secondary"
                >
                  <i class="bi bi-whatsapp fs-5"></i>
                </a>
