...
if(!isset($_COOKIE['login_email'])) {
  echo "Cookies UNSETTED, OR Cookie 'login_email' is not set!";
  echo "<br>Cookie 'login_password' is not set!";
} else {
  echo "Cookie login_email : ".$_COOKIE['login_email']."'<br>";
  echo "Cookie login_password : ".$_COOKIE['login_password']."'<br>";
}
?>
      ...
      >	  
        ...
        <div class="form__group mt-3">
          ...
          <div class="position-relative">
            ...
            <div class="invalid-feedback" id="error">Incorrect Password!</div>
          </div>
        </div>
        <div
        ...
        >
          <div>
            <input
              ...
              type="checkbox"
              value=""
			  name="remember" id="remember" <?php if(isset($_COOKIE["login_email"])) { ?> checked <?php } ?>
            />
            <label class="form-check-label text-white lh-1" for="remember"
              >Remember me</label
            >
          </div>
